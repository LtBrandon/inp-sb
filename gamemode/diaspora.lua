...
SKIN.PrintName 		= "Diaspora"
SKIN.Author 		= "Lt.Brandon"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material( "gwenskin/Diaspora.png" )
...
SKIN.Colours.Button = {}
SKIN.Colours.Button.Normal				= Color( 205, 205, 205, 255 );
SKIN.Colours.Button.Hover				= Color( 255, 205, 205, 255 );
...
SKIN.Colours.Tab.Inactive.Normal		= Color( 205, 205, 205, 255 );
...
SKIN.Colours.Label = {}
SKIN.Colours.Label.Default				= Color( 205, 205, 205, 255 );
SKIN.Colours.Label.Bright				= Color( 255, 255, 255, 255 );
SKIN.Colours.Label.Dark					= Color( 155, 155, 155, 255 );
SKIN.Colours.Label.Highlight			= Color( 255, 205, 205, 255 );

SKIN.Colours.Tree = {}
SKIN.Colours.Tree.Lines					= GWEN.TextureColor( 4 + 8 * 10, 508 );		---- !!!
SKIN.Colours.Tree.Normal				= Color( 205, 205, 205, 255 );
SKIN.Colours.Tree.Hover					= Color( 255, 205, 205, 255 );
SKIN.Colours.Tree.Selected				= Color( 255, 255, 255, 255 );

SKIN.Colours.Properties = {}
SKIN.Colours.Properties.Line_Normal			= Color( 205, 205, 205, 255 );
SKIN.Colours.Properties.Line_Selected		= Color( 255, 255, 255, 255 );
SKIN.Colours.Properties.Line_Hover			= Color( 255, 205, 205, 255 );
...
SKIN.Colours.Properties.Label_Normal		= Color( 205, 205, 205, 255 );
SKIN.Colours.Properties.Label_Selected		= Color( 255, 255, 255, 255 );
SKIN.Colours.Properties.Label_Hover			= Color( 255, 205, 205, 255 );

SKIN.Colours.Category = {}
SKIN.Colours.Category.Header				= Color( 255, 255, 255, 255 );
SKIN.Colours.Category.Header_Closed			= Color( 205, 205, 205, 255 );
SKIN.Colours.Category.Line = {}
SKIN.Colours.Category.Line.Text				= Color( 205, 205, 205, 255 );
SKIN.Colours.Category.Line.Text_Hover		= Color( 255, 205, 205, 255 );
...
SKIN.Colours.Category.LineAlt.Text				= Color( 205, 205, 205, 255 );
SKIN.Colours.Category.LineAlt.Text_Hover		= Color( 255, 205, 205, 255 );
...
derma.DefineSkin( "Diaspora", "For all the diasporian douches!", SKIN )